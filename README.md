...
> There are people who worship Temple OS  
> Then there are people who haven't seen Temple OS  
...
🤖 Alter ego Detected:- <a href="https://github.com/rugbedbugg" >Oxide 1-6 (@rugbedbugg)</a>  

🖥️ Linux Extremist  
🐧 Arch `bababoi` | Caelestia `is so fire` | Hyprland `should be a DE`  
🎨 Linux ricer & terminal maximalist `that one, yeah I can vouch for that`  
...
> *“That one linux setup you see in your social media feed”*  
...
*“The terminal doesn’t hide complexity, it hands it to you and asks if you’re worthy”*
